...
docker build -t aspnet-with-txcontrol-dependencies-v32:4.8-20240729 .

# tag with public repo prefix, so can push the update
docker tag aspnet-with-txcontrol-dependencies-v32:4.8-20240729 wallism/aspnet-with-txcontrol-dependencies-v32:4.8-20240729
# push to public repo (you need to login to dockerhub)
docker push wallism/aspnet-with-txcontrol-dependencies-v32:4.8-20240729
