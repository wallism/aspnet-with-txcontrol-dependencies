...
docker build -t aspnet-with-fonts:4.8-20240611 .


# tag with public repo prefix, so can push the update
docker tag aspnet-with-fonts:4.8-20240611 wallism/aspnet-with-fonts:4.8-20240611


# push to public repo (you need to login to dockerhub)
docker push wallism/aspnet-with-fonts:4.8-20240611
